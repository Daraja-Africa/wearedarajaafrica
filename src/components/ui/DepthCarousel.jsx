...
/**
 * @typedef {Object} DepthCarouselItem
 * @property {string} image
 * @property {string} [alt]
 */

/**
 * @typedef {Object} DepthCarouselProps
 * @property {Array<string|DepthCarouselItem>} [items]
 ...
 * @property {"left"|"right"} [tiltDirection]
 ...
 * @property {(index: number, item: DepthCarouselItem) => void} [onChange]
...
/** @param {DepthCarouselProps} props */
const DepthCarousel = ({
  items = DEFAULT_ITEMS,
  cardWidth = 300,
  cardHeight = 380,
  ...
  const rootStyle = /** @type {import('react').CSSProperties & Record<string, string>} */ ({
